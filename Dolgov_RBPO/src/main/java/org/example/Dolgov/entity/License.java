...
public class License {
    ...
    @Column(name = "first_activation_date", nullable = true)  // Дата первой активации лицензии, обязательная для заполнения
    private Date firstActivationDate;  // Дата активации лицензии

    @Column(name = "ending_date", nullable = true)  // Дата окончания срока действия лицензии
